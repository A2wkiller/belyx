                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    <span>{item.name}</span>
                                    {item.comingSoon && (
                                        <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-teal-500/10 text-teal-400 uppercase tracking-wider border border-teal-500/20 whitespace-nowrap">Soon</span>
                                    )}
                                </motion.span>
                                <motion.span
