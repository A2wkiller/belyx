                    ...
                    >
                      {link.comingSoon ? (
                        ...
                        >
                          ...
                          <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-teal-500/10 text-teal-400 uppercase tracking-wider border border-teal-500/20">
                            Soon
                          </span>
                        </div>
                      ) : (
      ...
      <footer className="bg-[#050505] border-t border-white/5 pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-white/20">
            <p>
              &copy; {new Date().getFullYear()} BelyxHost. All rights reserved.
            </p>
