              ...
              <div key={setIndex} className="flex gap-6">
                {reviews.map((review, i) => (
                  ...
                  >
                    ...
                    <p className="text-white/80 mb-8 text-sm leading-relaxed min-h-[80px]">
                      "{review.text}"
                    </p>
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-white text-sm ${review.featured ? "bg-teal-500 text-black" : "bg-white/10"}`}
                      >
                        {review.initial}
                      </div>
                      <div>
