      ...
      {isHighlighted && (
        <>
          ...
          <div className="absolute top-0 right-0 w-2 h-2">
            <div
              className="absolute top-0 right-0 w-full h-full bg-teal-400 rounded-full animate-ping"
          ...
          <div className="absolute bottom-0 left-0 w-2 h-2">
            <div
              className="absolute bottom-0 left-0 w-full h-full bg-teal-400 rounded-full animate-ping"
          ...
          <div className="absolute bottom-0 right-0 w-2 h-2">
            <div
              className="absolute bottom-0 right-0 w-full h-full bg-teal-400 rounded-full animate-ping"
